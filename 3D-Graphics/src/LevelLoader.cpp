...
#include "Cameras/SplineCamera.h"
...
std::unordered_map<std::string, ActorFunc> LevelLoader::sActorFactoryMap
{
	...
	{ "OrbitActor", &Actor::Create<OrbitActor> },
	{ "SplineActor", &Actor::Create<SplineActor> },
	{ "Sphere", &Actor::Create<Sphere> },
	{ "Cube", &Actor::Create<Cube> },
...
std::unordered_map<std::string, std::pair<int, ComponentFunc>> LevelLoader::sComponentFactoryMap
{
	...
	{ "BoxComponent", { Component::TBoxCollisionComponent, &Component::Create<BoxCollisionComponent> } },
	...
	{ "FPSCamera", { Component::TFPSCamera, &Component::Create<FPSCamera> } },
	{ "OrbitCamera", { Component::TOrbitCamera, &Component::Create<OrbitCamera> } },
	{ "SplineCamera", { Component::TSplineCamera, &Component::Create<SplineCamera> } },
...
bool LevelLoader::LoadJSON(const std::string& fileName, rapidjson::Document& outDoc)
{
	...
	// loaded with stream buffer at thee end (ate)
