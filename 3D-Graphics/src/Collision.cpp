...
SphereColl::SphereColl(const Vector3& center, float radius)
	:mCenter(center),
	mRadius(radius)
{
}

bool SphereColl::Contains(const Vector3& point) const
{
...
void AxisAlignedBoundingBox::UpdateMinMax(const Vector3& point)
{
...
void AxisAlignedBoundingBox::Rotate(const Quaternion& q)
{
...
bool AxisAlignedBoundingBox::Contains(const Vector3& point) const
{
...
float AxisAlignedBoundingBox::MinDistSq(const Vector3& point) const
{
...
bool SweptSphere(const SphereColl& P0, const SphereColl& P1, const SphereColl& Q0, const SphereColl& Q1, float& outT)
{
